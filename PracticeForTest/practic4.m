%A food store owner receives 1-liter water bottles from two suppliers. After
%some complaints from customers, he wants to check the accuracy of the weights
%of 1-liter water bottles. He finds the following weights (the two populations
...
[H1, P1, CI1, STATS1] = ttest2(X1, X2, 'alpha', alpha, 'tail', 'right', 'vartype', type);
